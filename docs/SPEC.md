...
> 最終更新: 2026-05-17 / バージョン: 20260517e
...
| バージョン | 日付 | 内容 |
|-----------|------|------|
| 20260517e | 2026-05-17 | バグ修正・UI改善: 銘柄整理モーダル削除バグ修正、ウォッチリスト固定列統一、AI吹き出しClaudeカラー化、LLMコーポレートカラー適用、パスキー指紋SVGアイコン、タイトル拡大、Pull-to-refresh実装 |
