...
> ✅ **調査完了（#492 クローズ）＋本実装完了（2026-06-25・PR#499 / Issue#493 クローズ）**＝Finnhub 週次バッチ→`sectorMedian`→米株 peer 破線（PER/EV-EBITDA）を実装。日本株は別系統（jp-fundamentals-source / TOPIX-17 ETF proxy・PR#500/#497）で補完。PM盤面モニタで完了確認（2026-06-25）。
