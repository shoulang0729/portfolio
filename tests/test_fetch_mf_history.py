...
class TestMergePreservesExtraKeys(unittest.TestCase):
    def test_csv_overwrite_keeps_liabilities(self):
        ...
        existing = [
            {"date": "2026-07-18", "total": 100, "cash": 10, "liabilities": ***REMOVED***},
        ...
        self.assertEqual(by["2026-07-18"]["liabilities"], ***REMOVED***)  # 保護
...
class TestStampLiabilities(unittest.TestCase):
    ...
    def test_stamps_matching_date_only(self):
        ...
        doc = {"asOf": "2026-07-19", "totals": {"liabilitiesTotal": ***REMOVED***}}
        self._with_holdings(doc, series)
        self.assertEqual(series[1]["liabilities"], ***REMOVED***)
